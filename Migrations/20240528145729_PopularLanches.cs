...
namespace WowLanches.Migrations
{
    public partial class PopularLanches : Migration
    {
        ...
        {
            migrationBuilder.Sql("INSERT INTO Lanches(CategoriaId,DescricaoCurta,DescricaoDetalhada,EmEstoque,ImagemThumbnailUrl,ImagemUrl,IsLanchePreferido,Nome,Preco) VALUES(1,'Pão com gergelim, 2 hambúrgeres , cebola caramelizada, bacon, queijo e picles e maionese da casa','Delicioso pão com 2 hamburgueres artesanais, cebola caramelizada, bacon tostadinho, queijo, picles e maionese da casa, feira com ingredientes de qualidade',1, '~/wwwroot/images/lan-1.jpg','~/wwwroot/images/lan-1.jpg', 0 ,'Montana Burguer', 23.50)");
